...
public class AccountService {
    ...
    public AccountDto get(String id) {
        ...
        /*
        Veritabanından gelen account nesnesini, modelmapper alıp AccountDTO çevirip öyle geri çevirecek.
         */
    }
    ...
    public Slice<AccountDto> findAll(Pageable pageable) {
        Slice<Account> accounts =accountRepository.findAll((org.springframework.data.domain.Pageable) pageable);
        return null;
    }
}
